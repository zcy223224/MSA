...
bestlist=[1,1,1000,10,100,10,1,-8000,50,10,1,10,10,10,-1000,50,1]
timesof4=[0,3000,0,0]
'''SSA, MSA,GWO,FA'''
def fitness(elem):
...
n=0
before=[]
while(timesof4[0]<1000000):
    if(specie[0][dimension]<bestlist[functionorder]):
        break
    '''发现者更新中'''
    R2=np.random.rand()
    i=0
...
counter=0
while(counter<maxnumber):
    start=int(np.random.rand()*10050)+500
